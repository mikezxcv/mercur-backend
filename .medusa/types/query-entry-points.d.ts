...
export type ConfigurationRuleRuleTypeEnum =
...
export type ConfigurationRule = {
  __typename?: 'ConfigurationRule';
  id: Scalars['ID']['output'];
  rule_type: ConfigurationRuleRuleTypeEnum;
...
export type OrderSet = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  order_link: Maybe<Array<Maybe<LinkMarketplaceOrderSetOrderOrder>>>;
  orders: Maybe<Array<Maybe<Order>>>;
};

export type SplitOrderPayment = {
  __typename?: 'SplitOrderPayment';
  id: Scalars['ID']['output'];
  status: Scalars['String']['output'];
  currency_code: Scalars['String']['output'];
  authorized_amount: Scalars['Float']['output'];
  captured_amount: Scalars['Float']['output'];
  refunded_amount: Scalars['Float']['output'];
  payment_collection_id: Scalars['String']['output'];
  raw_authorized_amount: Scalars['JSON']['output'];
  raw_captured_amount: Scalars['JSON']['output'];
  raw_refunded_amount: Scalars['JSON']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  order_link: Maybe<LinkOrderOrderSplitOrderPaymentSplitOrderPayment>;
  order: Maybe<Order>;
};
...
export type TaxCode = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  product_category_link: Maybe<Array<Maybe<LinkProductProductCategoryTaxcodeTaxCode>>>;
...
export type ReviewReferenceEnum =
  | 'product'
  | 'seller';
...
export type Review = {
  __typename?: 'Review';
  id: Scalars['ID']['output'];
  reference: ReviewReferenceEnum;
  rating: Scalars['Int']['output'];
  customer_note: Maybe<Scalars['String']['output']>;
  seller_note: Maybe<Scalars['String']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  customer_link: Maybe<LinkCustomerCustomerReviewReview>;
  customer: Maybe<Customer>;
  order_link: Maybe<LinkOrderOrderReviewReview>;
  order: Maybe<Order>;
  product_link: Maybe<LinkProductProductReviewReview>;
  product: Maybe<Product>;
  seller_link: Maybe<LinkSellerSellerReviewReview>;
  seller: Maybe<Seller>;
};
...
export type Request = {
  ...
  submitter_id: Scalars['String']['output'];
  reviewer_id: Maybe<Scalars['String']['output']>;
  reviewer_note: Maybe<Scalars['String']['output']>;
  status: RequestStatusEnum;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  seller_link: Maybe<LinkSellerSellerRequestsRequest>;
  seller: Maybe<Seller>;
};
...
export type OrderReturnRequestStatusEnum =
  | 'pending'
  | 'refunded'
  | 'withdrawn'
  | 'escalated'
...
export type OrderReturnRequest = {
  ...
  customer_note: Scalars['String']['output'];
  shipping_option_id: Maybe<Scalars['String']['output']>;
  vendor_reviewer_id: Maybe<Scalars['String']['output']>;
  vendor_reviewer_note: Maybe<Scalars['String']['output']>;
  vendor_review_date: Maybe<Scalars['DateTime']['output']>;
  admin_reviewer_id: Maybe<Scalars['String']['output']>;
  admin_reviewer_note: Maybe<Scalars['String']['output']>;
  admin_review_date: Maybe<Scalars['DateTime']['output']>;
  line_items: Array<Maybe<OrderReturnRequestLineItem>>;
  status: OrderReturnRequestStatusEnum;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  order_link: Maybe<LinkOrderReturnOrderReturnRequestOrderOrder>;
  order: Maybe<Order>;
  seller_link: Maybe<LinkSellerSellerOrderReturnOrderReturnRequest>;
  seller: Maybe<Seller>;
};

export type OrderReturnRequestLineItem = {
  __typename?: 'OrderReturnRequestLineItem';
  id: Scalars['ID']['output'];
  line_item_id: Scalars['String']['output'];
  quantity: Scalars['Int']['output'];
  reason_id: Maybe<Scalars['String']['output']>;
  return_request_id: Scalars['String']['output'];
...
export type StockLocation = {
  ...
  sales_channels: Maybe<Array<Maybe<SalesChannel>>>;
  seller_link: Maybe<LinkSellerSellerStockLocationStockLocation>;
  seller: Maybe<Seller>;
};
...
export type CommissionRate = {
  ...
  id: Scalars['ID']['output'];
  type: Scalars['String']['output'];
  percentage_rate: Maybe<Scalars['Int']['output']>;
  include_tax: Scalars['Boolean']['output'];
  price_set_id: Maybe<Scalars['String']['output']>;
  max_price_set_id: Maybe<Scalars['String']['output']>;
  min_price_set_id: Maybe<Scalars['String']['output']>;
...
export type CommissionLine = {
  ...
  id: Scalars['ID']['output'];
  item_line_id: Scalars['String']['output'];
...
export type InventoryItem = {
  ...
  seller_link: Maybe<LinkSellerSellerInventoryInventoryItem>;
  seller: Maybe<Seller>;
};
...
export type Payout = {
  ...
  reversals: Array<Maybe<PayoutReversal>>;
  raw_amount: Scalars['JSON']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  order_link: Maybe<LinkOrderPayout>;
  order: Maybe<Order>;
};

export type PayoutReversal = {
  __typename?: 'PayoutReversal';
  id: Scalars['ID']['output'];
  currency_code: Scalars['String']['output'];
  amount: Scalars['Float']['output'];
  data: Maybe<Scalars['JSON']['output']>;
...
export type MemberInviteRoleEnum =
  | 'owner'
  | 'admin'
  | 'member';
...
export type SellerStoreStatusEnum =
  | 'ACTIVE'
  | 'INACTIVE'
  | 'SUSPENDED';
...
export type Seller = {
  __typename?: 'Seller';
  id: Scalars['ID']['output'];
  store_status: SellerStoreStatusEnum;
  name: Scalars['String']['output'];
  handle: Scalars['String']['output'];
  description: Maybe<Scalars['String']['output']>;
  photo: Maybe<Scalars['String']['output']>;
  ...
  invites: Array<Maybe<MemberInvite>>;
  onboarding: Maybe<SellerOnboarding>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  review_link: Maybe<Array<Maybe<LinkSellerSellerReviewReview>>>;
  reviews: Maybe<Array<Maybe<Review>>>;
  campaign_link: Maybe<Array<Maybe<LinkSellerSellerPromotionCampaign>>>;
  campaigns: Maybe<Array<Maybe<Campaign>>>;
  customer_group_link: Maybe<Array<Maybe<LinkSellerSellerCustomerCustomerGroup>>>;
  customer_groups: Maybe<Array<Maybe<CustomerGroup>>>;
  fulfillment_set_link: Maybe<Array<Maybe<LinkSellerSellerFulfillmentFulfillmentSet>>>;
  fulfillment_sets: Maybe<Array<Maybe<FulfillmentSet>>>;
  inventory_item_link: Maybe<Array<Maybe<LinkSellerSellerInventoryInventoryItem>>>;
  inventory_items: Maybe<Array<Maybe<InventoryItem>>>;
  order_link: Maybe<Array<Maybe<LinkSellerSellerOrderOrder>>>;
  orders: Maybe<Array<Maybe<Order>>>;
  payout_account_link: Maybe<LinkSellerSellerPayoutPayoutAccount>;
  payout_account: Maybe<PayoutAccount>;
  price_list_link: Maybe<Array<Maybe<LinkSellerSellerPricingPriceList>>>;
  price_lists: Maybe<Array<Maybe<PriceList>>>;
  product_link: Maybe<Array<Maybe<LinkSellerSellerProductProduct>>>;
  products: Maybe<Array<Maybe<Product>>>;
  promotion_link: Maybe<Array<Maybe<LinkSellerSellerPromotionPromotion>>>;
  promotions: Maybe<Array<Maybe<Promotion>>>;
  return_link: Maybe<Array<Maybe<LinkSellerSellerOrderReturn>>>;
  ...
  shipping_option_link: Maybe<Array<Maybe<LinkSellerSellerFulfillmentShippingOption>>>;
  shipping_options: Maybe<Array<Maybe<ShippingOption>>>;
  shipping_profile_link: Maybe<Array<Maybe<LinkSellerSellerFulfillmentShippingProfile>>>;
  shipping_profiles: Maybe<Array<Maybe<ShippingProfile>>>;
  stock_location_link: Maybe<Array<Maybe<LinkSellerSellerStockLocationStockLocation>>>;
  stock_locations: Maybe<Array<Maybe<StockLocation>>>;
  request_link: Maybe<Array<Maybe<LinkSellerSellerRequestsRequest>>>;
  requests: Maybe<Array<Maybe<Request>>>;
  order_return_request_link: Maybe<Array<Maybe<LinkSellerSellerOrderReturnOrderReturnRequest>>>;
  order_return_requests: Maybe<Array<Maybe<OrderReturnRequest>>>;
};

export type SellerOnboarding = {
  __typename?: 'SellerOnboarding';
  id: Scalars['ID']['output'];
  store_information: Scalars['Boolean']['output'];
  stripe_connection: Scalars['Boolean']['output'];
  locations_shipping: Scalars['Boolean']['output'];
...
export type CustomerGroup = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  seller_link: Maybe<LinkSellerSellerCustomerCustomerGroup>;
  seller: Maybe<Seller>;
};
...
export type Customer = {
  ...
  review_link: Maybe<Array<Maybe<LinkCustomerCustomerReviewReview>>>;
  reviews: Maybe<Array<Maybe<Review>>>;
...
export type PriceList = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  seller_link: Maybe<LinkSellerSellerPricingPriceList>;
  seller: Maybe<Seller>;
};
...
export type Promotion = {
  ...
  seller_link: Maybe<LinkSellerSellerPromotionPromotion>;
  seller: Maybe<Seller>;
};
...
export type Campaign = {
  ...
  promotions: Maybe<Array<Maybe<Promotion>>>;
  seller_link: Maybe<LinkSellerSellerPromotionCampaign>;
  seller: Maybe<Seller>;
};
...
export type Product = {
  ...
  review_link: Maybe<Array<Maybe<LinkProductProductReviewReview>>>;
  reviews: Maybe<Array<Maybe<Review>>>;
  ...
  seller_link: Maybe<LinkSellerSellerProductProduct>;
  seller: Maybe<Seller>;
  wishlist_link: Maybe<LinkWishlistWishlistProductProduct>;
  wishlist: Maybe<Wishlist>;
};
...
export type ProductCategory = {
  ...
  tax_code_link: Maybe<LinkProductProductCategoryTaxcodeTaxCode>;
  tax_code: Maybe<TaxCode>;
};
...
export type Order = {
  ...
  review_link: Maybe<Array<Maybe<LinkOrderOrderReviewReview>>>;
  reviews: Maybe<Array<Maybe<Review>>>;
  payout_link: Maybe<Array<Maybe<LinkOrderPayout>>>;
  payouts: Maybe<Array<Maybe<Payout>>>;
  order_set_link: Maybe<LinkMarketplaceOrderSetOrderOrder>;
  order_set: Maybe<OrderSet>;
  split_order_payment_link: Maybe<LinkOrderOrderSplitOrderPaymentSplitOrderPayment>;
  split_order_payment: Maybe<SplitOrderPayment>;
  seller_link: Maybe<LinkSellerSellerOrderOrder>;
  seller: Maybe<Seller>;
  order_return_request_link: Maybe<Array<Maybe<LinkOrderReturnOrderReturnRequestOrderOrder>>>;
  order_return_requests: Maybe<Array<Maybe<OrderReturnRequest>>>;
};
...
export type Return = {
  ...
  fulfillments: Maybe<Array<Maybe<Fulfillment>>>;
  seller_link: Maybe<LinkSellerSellerOrderReturn>;
  seller: Maybe<Seller>;
};
...
export type ShippingOption = {
  ...
  seller_link: Maybe<LinkSellerSellerFulfillmentShippingOption>;
  seller: Maybe<Seller>;
};
...
export type ShippingProfile = {
  ...
  seller_link: Maybe<LinkSellerSellerFulfillmentShippingProfile>;
  seller: Maybe<Seller>;
};
...
export type LinkCustomerCustomerReviewReview = {
  __typename?: 'LinkCustomerCustomerReviewReview';
  customer_id: Scalars['String']['output'];
  review_id: Scalars['String']['output'];
  customer: Maybe<Customer>;
  review: Maybe<Review>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
export type LinkOrderOrderReviewReview = {
  __typename?: 'LinkOrderOrderReviewReview';
  order_id: Scalars['String']['output'];
  review_id: Scalars['String']['output'];
  order: Maybe<Order>;
  review: Maybe<Review>;
...
export type LinkProductProductReviewReview = {
  __typename?: 'LinkProductProductReviewReview';
  product_id: Scalars['String']['output'];
  review_id: Scalars['String']['output'];
  product: Maybe<Product>;
  review: Maybe<Review>;
...
export type LinkSellerSellerReviewReview = {
  __typename?: 'LinkSellerSellerReviewReview';
  seller_id: Scalars['String']['output'];
  review_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  review: Maybe<Review>;
...
export type LinkProductProductCategoryTaxcodeTaxCode = {
  __typename?: 'LinkProductProductCategoryTaxcodeTaxCode';
  product_category_id: Scalars['String']['output'];
  tax_code_id: Scalars['String']['output'];
  product_category: Maybe<ProductCategory>;
  tax_code: Maybe<TaxCode>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
export type LinkOrderPayout = {
  __typename?: 'LinkOrderPayout';
  order_id: Scalars['String']['output'];
  payout_id: Scalars['String']['output'];
  order: Maybe<Order>;
  payout: Maybe<Payout>;
...
export type LinkMarketplaceOrderSetOrderOrder = {
  __typename?: 'LinkMarketplaceOrderSetOrderOrder';
  order_set_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  order_set: Maybe<OrderSet>;
  order: Maybe<Order>;
  createdAt: Scalars['String']['output'];
...
export type LinkOrderOrderSplitOrderPaymentSplitOrderPayment = {
  __typename?: 'LinkOrderOrderSplitOrderPaymentSplitOrderPayment';
  order_id: Scalars['String']['output'];
  split_order_payment_id: Scalars['String']['output'];
  order: Maybe<Order>;
  split_order_payment: Maybe<SplitOrderPayment>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
export type LinkSellerSellerPromotionCampaign = {
  __typename?: 'LinkSellerSellerPromotionCampaign';
  seller_id: Scalars['String']['output'];
...
export type LinkSellerSellerCustomerCustomerGroup = {
  __typename?: 'LinkSellerSellerCustomerCustomerGroup';
  seller_id: Scalars['String']['output'];
  customer_group_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  customer_group: Maybe<CustomerGroup>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
  deletedAt: Maybe<Scalars['String']['output']>;
};
...
export type LinkSellerSellerInventoryInventoryItem = {
  __typename?: 'LinkSellerSellerInventoryInventoryItem';
  seller_id: Scalars['String']['output'];
  inventory_item_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
...
export type LinkSellerSellerOrderOrder = {
  __typename?: 'LinkSellerSellerOrderOrder';
  seller_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  order: Maybe<Order>;
...
export type LinkSellerSellerPricingPriceList = {
  __typename?: 'LinkSellerSellerPricingPriceList';
  seller_id: Scalars['String']['output'];
...
export type LinkSellerSellerProductProduct = {
  __typename?: 'LinkSellerSellerProductProduct';
  seller_id: Scalars['String']['output'];
  product_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  product: Maybe<Product>;
...
export type LinkSellerSellerPromotionPromotion = {
  __typename?: 'LinkSellerSellerPromotionPromotion';
  seller_id: Scalars['String']['output'];
  promotion_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  promotion: Maybe<Promotion>;
...
export type LinkSellerSellerOrderReturn = {
  __typename?: 'LinkSellerSellerOrderReturn';
  seller_id: Scalars['String']['output'];
  return_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  return: Maybe<Return>;
...
export type LinkSellerSellerFulfillmentShippingOption = {
  __typename?: 'LinkSellerSellerFulfillmentShippingOption';
  seller_id: Scalars['String']['output'];
  shipping_option_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  shipping_option: Maybe<ShippingOption>;
...
export type LinkSellerSellerFulfillmentShippingProfile = {
  __typename?: 'LinkSellerSellerFulfillmentShippingProfile';
  seller_id: Scalars['String']['output'];
  shipping_profile_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  shipping_profile: Maybe<ShippingProfile>;
...
export type LinkSellerSellerStockLocationStockLocation = {
  __typename?: 'LinkSellerSellerStockLocationStockLocation';
  seller_id: Scalars['String']['output'];
  stock_location_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
...
export type LinkOrderReturnOrderReturnRequestOrderOrder = {
  __typename?: 'LinkOrderReturnOrderReturnRequestOrderOrder';
  order_return_request_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  order_return_request: Maybe<OrderReturnRequest>;
  order: Maybe<Order>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
  deletedAt: Maybe<Scalars['String']['output']>;
...
export type LinkSellerSellerRequestsRequest = {
  __typename?: 'LinkSellerSellerRequestsRequest';
  seller_id: Scalars['String']['output'];
...
export type LinkSellerSellerOrderReturnOrderReturnRequest = {
  __typename?: 'LinkSellerSellerOrderReturnOrderReturnRequest';
  seller_id: Scalars['String']['output'];
  order_return_request_id: Scalars['String']['output'];
  seller: Maybe<Seller>;
  order_return_request: Maybe<OrderReturnRequest>;
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    split_order_payments: SplitOrderPayment
    tax_code: TaxCode
    tax_codes: TaxCode
    wishlist: Wishlist
    wishlists: Wishlist
    ...
    order_return_request_line_item: OrderReturnRequestLineItem
    order_return_request_line_items: OrderReturnRequestLineItem
    ...
    payout_reversals: PayoutReversal
    payout_account: PayoutAccount
    ...
    seller_onboardings: SellerOnboarding
    ...
    customer_review: LinkCustomerCustomerReviewReview
    order_review: LinkOrderOrderReviewReview
    product_review: LinkProductProductReviewReview
    seller_review: LinkSellerSellerReviewReview
    product_category_attribute: LinkProductProductCategoryAttributeAttribute
    product_category_tax_code: LinkProductProductCategoryTaxcodeTaxCode
    customer_wishlist: LinkCustomerCustomerWishlistWishlist
    order_payout: LinkOrderPayout
    order_set_order: LinkMarketplaceOrderSetOrderOrder
    order_split_order_payment: LinkOrderOrderSplitOrderPaymentSplitOrderPayment
    product_attribute_value: LinkProductProductAttributeAttributeValue
    seller_campaign: LinkSellerSellerPromotionCampaign
    seller_customer_group: LinkSellerSellerCustomerCustomerGroup
    seller_fulfillment_set: LinkSellerSellerFulfillmentFulfillmentSet
    seller_inventory_item: LinkSellerSellerInventoryInventoryItem
    seller_order: LinkSellerSellerOrderOrder
    seller_payout_account: LinkSellerSellerPayoutPayoutAccount
    seller_price_list: LinkSellerSellerPricingPriceList
    seller_product: LinkSellerSellerProductProduct
    seller_promotion: LinkSellerSellerPromotionPromotion
    seller_return: LinkSellerSellerOrderReturn
    seller_service_zone: LinkSellerSellerFulfillmentServiceZone
    seller_shipping_option: LinkSellerSellerFulfillmentShippingOption
    seller_shipping_profile: LinkSellerSellerFulfillmentShippingProfile
    seller_stock_location: LinkSellerSellerStockLocationStockLocation
    wishlist_product: LinkWishlistWishlistProductProduct
    order_return_request_order: LinkOrderReturnOrderReturnRequestOrderOrder
    seller_request: LinkSellerSellerRequestsRequest
    seller_order_return_request: LinkSellerSellerOrderReturnOrderReturnRequest
  }
}